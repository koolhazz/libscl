...
CHANGE LOG
	...
	16dec04	drj	map_insert() returns SCL_DUPKEY for duplicate keys.
...
SCL_map_t (map_new) (void)
   {
   S_SCL_map_t* const map = SCL_ALLOCATOR (sizeof(S_SCL_map_t));
...
/*****************************************************************************
 * Public Function map_erase
 *****************************************************************************/

void (map_erase) (SCL_map_t a_map)
   {
   S_SCL_map_t* const map = a_map;
...
size_t (map_size) (SCL_map_t a_map)
   {
   return a_map->size;
   }
...
/*****************************************************************************
 * Public Function map_count
 *****************************************************************************/

size_t (map_count) (SCL_map_t a_map)
   {
   return a_map->count;
   }
...
int (map_insert) (SCL_map_t a_map, long a_key, const void* a_data)
   {
   S_SCL_map_t* const map = a_map;
...
/*****************************************************************************
 * Public Function map_replace
 *****************************************************************************/

int (map_replace) (SCL_map_t a_map, long a_key, const void* a_data)
   {
   S_SCL_map_t* const map = a_map;
   const long index = hashfn (map->bmod, a_key);
...
void* (map_remove) (SCL_map_t a_map, long a_key)
   {
   S_SCL_map_t* const map = a_map;
   const long index = hashfn (map->bmod, a_key);
...
/*****************************************************************************
 * Public Function map_access
 *****************************************************************************/

void* (map_access) (SCL_map_t a_map, long a_key)
   {
...
SCL_iterator_t (map_at) (SCL_map_t a_map, long a_key)
   {
   const long index = hashfn (a_map->bmod, a_key);
...
/*****************************************************************************
 * Public Function map_begin
 *****************************************************************************/

SCL_iterator_t (map_begin) (SCL_map_t a_map)
   {
...
SCL_iterator_t (map_end) (SCL_map_t a_map)
   {
   const S_node_t* node = NULL;
...
/*****************************************************************************
 * Public Function map_next
 *****************************************************************************/

SCL_iterator_t (map_next) (SCL_iterator_t a_iterator)
   {
...
/*****************************************************************************
 * Public Function map_prev
 *****************************************************************************/

SCL_iterator_t (map_prev) (SCL_iterator_t a_iterator)
   {
   const S_node_t* node = a_iterator;
...
/*****************************************************************************
 * Public Function map_data_set
 *****************************************************************************/

void (map_data_set) (SCL_iterator_t a_iterator, const void* a_data)
   {
...
/*****************************************************************************
 * Public Function map_data_get
 *****************************************************************************/

void* (map_data_get) (SCL_iterator_t a_iterator)
   {
...
/*****************************************************************************
 * Public Function map_foreach
 *****************************************************************************/

void (map_foreach) (SCL_map_t a_map, SCL_cbfn_t a_func, void* a_context)
   {
   const S_node_t* node;
